...
const MENU_GROUPS = [
  {
    ...
    items: [
      ...
      { name: 'Question', href: '/super-admin/questions', icon: FileQuestion },
    ...
    <div className="flex fixed inset-0 bg-[#f4f7fb] text-gray-900 overflow-hidden font-sans">
      ...
      <main className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        <header className="bg-white border-b border-[#e2e8f0] h-16 shrink-0 flex items-center justify-between px-5 z-30">
          ...
          <div className="ml-auto flex items-center gap-3 cursor-pointer hover:bg-gray-100 md:hover:bg-gray-200/50 p-1.5 pr-3 rounded-full transition-colors">
